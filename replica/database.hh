...
private:
    ...
    bool _critical_disk_utilization_mode = false;
...
public:
    ...
    static future<> set_critical_disk_utilization_mode_on_all_shards(sharded<database>& sharded_db, bool enabled);
    bool is_critical_disk_utilization_mode() const { return _critical_disk_utilization_mode; }
